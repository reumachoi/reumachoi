...
| 기간 | 활동명 | 내용 |
| ------ | -- |---------------- |
| 2021.11.15~04.18|국비지원 수강 | 멀티캠퍼스 시큐어코딩 앱개발과정 수강 |
| 2021.12~2022.04 | 알고리즘 스터디 | 자바 알고리즘 스터디 참여   |

### 프로젝트
| 기간 | 프로젝트명 | 내용 | 사용언어&프레임워크 |
| ------ | -- |---------------- |---------------- |
| 2022.01.11~2022.01.20|세미프로젝트 | 주식&부동산 커뮤니티 웹 | Html, Css, JS, Java, Spring, Oracle|
| 2022.03.14~04.18 | 파이널프로젝트 | 가게 큐레이션 앱 |  Html, Css, JS, Kotiln, Java, SpringBoot, MyBatis, Oracle |
